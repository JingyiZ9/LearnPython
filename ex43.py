...
class Engine(object):
    ...
    def play(self):
        ...
        ##get the next scene name and set the next scene to the current scene
        while True:
            print ("\n--------")
            next_scene_name = current_scene.enter()
            current_scene = self.scene_map.next_scene(next_scene_name)

## the parent of Death is Scene
class Death(Scene):
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        if guess == code:
            print ("The container cliks open and the seal breaks, letting gas out.")
...
class TheBridge(Scene):
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print ("As you die you see another Gothon franticallt try to disarm")
